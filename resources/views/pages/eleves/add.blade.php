            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="myGroup">
                        <form action="{{ route('eleves.save') }}" method="POST">
                            {{ csrf_field() }}
                            <div>
                                <p>
                                    <a class="nav-link"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input class="form-control" type="text" placeholder="Genre"
                                                    name="genre" value="{{ old('genre') }}" required autofocus>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div class="d-flex flex-wrap">
                                                    ...
                                                    <div class="mr-2">
                                                        <input type="radio" name="nature_etablissement"
                                                            id="nature_etablissement" value="public"
                                                            value="{{ old('nature_etablissement') }}" required autofocus>

                                                        @if ($errors->has('nature_etablissement'))
                                                            <div class="mt-3">
                                                                <span class="help-block" style="color: rgb(242, 64, 64)">
                                                                    {{ $errors->first('nature_etablissement') }}
                                                                </span>
                                                            </div>
                                                        @endif
                                                        <label class="form-check-label" for="nature_etablissement">
                                                            Public
                                                        </label>
                                                    </div>
                                                    <div class="">
                                                        <input type="radio" name="nature_etablissement"
                                                            id="nature_etablissement2" value="privé"
                                                            value="{{ old('nature_etablissement') }}" required autofocus>
                                                        ...
                                                        @endif
                                                        <label class="form-check-label" for="nature_etablissement2">
                                                            Privé
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div class="flex-wrap">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="type_etablissement"
                                                            id="type_etablissement1" value="Elémentaire" checked
                                                            name="code" value="{{ old('type_etablissement') }}"
                                                            required autofocus>

                                                        @if ($errors->has('type_etablissement'))
                                                            <div class="mt-3">
                                                                <span class="help-block" style="color: rgb(242, 64, 64)">
                                                                    {{ $errors->first('type_etablissement') }}
                                                                </span>
                                                            </div>
                                                        @endif
                                                        <label class="form-check-label" for="type_etablissement1">
                                                            Elémentaire
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="">
                                                        <input type="radio" id="type_etablissement" value="Moyen"
                                                            name="type_etablissement"
                                                            value="{{ old('type_etablissement') }}" required autofocus>
                                                        ...
                                                        @endif
                                                        <label class="form-check-label" for="type_etablissement">
                                                            Moyen
                                                        </label>
                                                    </div>
                                                    <div class="">
                                                        <input type="radio" name="type_etablissement"
                                                            id="type_etablissement2" value="Secondaire" name="code"
                                                            value="{{ old('type_etablissement') }}" required autofocus>
                                                        ...
                                                        @endif
                                                        <label class="form-check-label" for="type_etablissement2">
                                                            Secondaire
                                                        </label>
                                                    </div>
