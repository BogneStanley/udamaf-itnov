...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/eleves/list', "CmuEleveController@index")->name("eleves.list");
    Route::get('/eleves/add', "CmuEleveController@create")->name("eleves.add");
    Route::post('/eleves/add', "CmuEleveController@store")->name("eleves.save");




    Route::post('/admin/register', 'AuthController@register')->name("admin.register");




    Route::get('/cmu_dara/list', "CmuDaraController@index")->name("cmu_dara.list");
    Route::get('/cmu_dara/add', "CmuDaraController@create")->name("cmu_dara.add");
    Route::post('/cmu_dara/add', "CmuDaraController@store")->name("cmu_dara.save");


    Route::get('/cmu_classique/list', "CmuClassiqueController@index")->name("cmu_classique.list");
    Route::get('/cmu_classique/add', "CmuClassiqueController@create")->name("cmu_classique.add");


    Route::get('/securite_familiale/list', "SecuFamilialeController@index")->name("securite_familiale.list");
    Route::get('/securite_familiale/add', "SecuFamilialeController@create")->name("securite_familiale.add");


    Route::get('/gestion_utilisateur/list', "UserController@index")->name("gestion_utilisateur.list");
    Route::get('/gestion_utilisateur/add', "UserController@create")->name("gestion_utilisateur.add");


    Route::get('/admin', 'DashboardController@index')->name("accueil");
